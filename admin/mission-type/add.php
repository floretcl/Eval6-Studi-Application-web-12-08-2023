...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  try {
    ...
    $message = "Error: unable to add mission type";
  }
}
?>
    ...
    <main>
      <div class="container-fluid container-sm text-light">
        <div class="text-center my-5">
          ...
          <h2 class="text-uppercase font-monospace">Add mission type</h2>
        </div>
        <div>
          ...
          <div class="row mt-2 pb-2 mb-4 overflow-x-scroll">
            <form action="" method="post">
              <?php if (isset($message)) : ?>
                <div class="alert <?= $message == 'Mission type added' ? 'alert-success' : 'alert-danger' ?> d-flex align-items-center" role="alert">
                <?php if ($message == 'Mission type added') : ?>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="mission-type-name" name="mission-type-name" value="" maxlength="50" aria-describedby="name-help" required>
