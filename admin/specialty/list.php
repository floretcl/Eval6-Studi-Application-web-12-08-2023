...
if (($_SERVER['REQUEST_METHOD'] === 'POST')) {
  ...
  try {
    ...
    $message = "Error: unable to delete specialty";
  }
}
...
try {
  ...
  $message = "Error: unable to get number of specialties";
}
...
try {
    ...
    $sql = 'SELECT 
        ...
        FROM Specialty
        WHERE Specialty.specialty_name LIKE :search
...
<head>
  ...
  <title>KGB : missions | administration | specialties</title>
</head>
...
<body>
        ...
        <div class="row justify-content-center gx-5 gy-3 mb-4">
          <div class="col-10 col-sm-7 col-md-6 col-lg-5">
            <form class="d-flex" action="" method="GET" role="search">
              <input class="form-control me-2" id="search-input" name="search" type="search" placeholder="<?= $search == '' ? 'Search by name' : '' ?>" value="<?= $search == '' ? '' : $search ?>" aria-label="Search specialty by name">
        ...
        <div class="row mt-2 pb-2 mb-4 overflow-x-scroll">
          ...
          <table class="table table-dark table-striped table-hover">
            ...
            <?php if (isset($specialties)): ?>
              ...
              <tr>
              <td class="font-monospace"><input id="table-checkbox-<?= $specialty->getName(); ?>" name="table-checkbox-<?= $specialty->getName(); ?>" class="table-checkbox" type="checkbox" value="<?= $specialty->getId(); ?>"></td>
              <td class="font-monospace">
                <a href="./specialty.php?id=<?= $specialty->getId(); ?>">
                  <?= $specialty->getId(); ?>
                </a>
              </td>
              <?php
  ...
  <script src="../../assets/js/specialty/list.js"></script>
</body>
