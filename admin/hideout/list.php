...
if (($_SERVER['REQUEST_METHOD'] === 'POST')) {
  ...
  try {
    ...
    $sql = 'DELETE 
      FROM Hideout 
      WHERE Hideout.hideout_uuid = :uuid';
    ...
    $message = "Error: unable to delete hideout";
  }
}
...
try {
  ...
  $message = "Error: unable to get number of hideouts";
}
...
<head>
  ...
  <title>KGB : missions | administration | hideouts</title>
</head>
...
<body>
        ...
        <div class="row justify-content-center gx-5 gy-3 mb-4">
          <div class="col-10 col-sm-7 col-md-6 col-lg-5">
            <form class="d-flex" action="" method="GET" role="search">
              <input class="form-control me-2" id="search-input" name="search" type="search" placeholder="<?= $search == '' ? 'Search by code name' : '' ?>" value="<?= $search == '' ? '' : $search ?>" aria-label="Search hideout by code name">
        ...
        <div class="row mt-2 pb-2 mb-4 overflow-x-scroll">
          ...
          <table class="table table-dark table-striped table-hover">
            ...
            <?php if (isset($hideouts)): ?>
              ...
              <tr>
              <td class="font-monospace"><input id="table-checkbox-<?= $hideout->getCodeName(); ?>" name="table-checkbox-<?= $hideout->getCodeName(); ?>" class="table-checkbox" type="checkbox" value="<?= $hideout->getUUID(); ?>"></td>
              <td class="font-monospace">
                <a href="./hideout.php?id=<?= $hideout->getUUID(); ?>">
                  <?= $hideout->getUUID(); ?>
                </a>
              </td>
              <?php
  ...
  <script src="../../assets/js/hideout/list.js"></script>
</body>
