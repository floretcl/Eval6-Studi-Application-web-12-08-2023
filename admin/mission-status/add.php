...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  try {
    ...
    $message = "Error: unable to add mission status";
  }
}
?>
          ...
          <div class="row mt-2 pb-2 mb-4 overflow-x-scroll">
            <form action="" method="post">
              <?php if (isset($message)) : ?>
                <div class="alert <?= $message == 'Mission status added' ? 'alert-success' : 'alert-danger' ?> d-flex align-items-center" role="alert">
                <?php if ($message == 'Mission status added') : ?>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="mission-status-name" name="mission-status-name" value="" maxlength="50" aria-describedby="name-help" required>
