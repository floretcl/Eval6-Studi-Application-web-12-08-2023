...
if (($_SERVER['REQUEST_METHOD'] === 'POST')) {
  ...
  try {
    ...
    $sql = 'DELETE 
      FROM Hideout_type 
      WHERE Hideout_type.hideout_type_id = :id';
    ...
    $message = "Error: unable to delete hideout type";
  }
}
...
try {
  ...
  $message = "Error: unable to get number of hideout types";
}
...
try {
    ...
    $sql = 'SELECT 
        ...
        FROM Hideout_type
        WHERE Hideout_type.hideout_type_name LIKE :search
    ...
    $message = "Error: unable to display hideout types list";
}
...
<head>
  ...
  <title>KGB : missions | administration | hideout types</title>
</head>
...
<body>
        ...
        <div class="row justify-content-center gx-5 gy-3 mb-4">
          <div class="col-10 col-sm-7 col-md-6 col-lg-5">
            <form class="d-flex" action="" method="GET" role="search">
              <input class="form-control me-2" id="search-input" name="search" type="search" placeholder="<?= $search == '' ? 'Search by name' : '' ?>" value="<?= $search == '' ? '' : $search ?>" aria-label="Search hideout type by name">
  ...
  <script src="../../assets/js/hideout-type/list.js"></script>
</body>
