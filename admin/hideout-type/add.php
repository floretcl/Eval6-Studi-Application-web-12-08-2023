...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  try {
    ...
    $message = "Error: unable to add hideout type";
  }
}
?>
    ...
    <main>
      <div class="container-fluid container-sm text-light">
        <div class="text-center my-5">
          ...
          <h2 class="text-uppercase font-monospace">Add hideout type</h2>
        </div>
        <div>
          ...
          <div class="row mt-2 pb-2 mb-4 overflow-x-scroll">
            <form action="" method="post">
              <?php if (isset($message)) : ?>
                <div class="alert <?= $message == 'Hideout type added' ? 'alert-success' : 'alert-danger' ?> d-flex align-items-center" role="alert">
                <?php if ($message == 'Hideout type added') : ?>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="hideout-type-name" name="hideout-type-name" value="" maxlength="50" aria-describedby="name-help" required>
