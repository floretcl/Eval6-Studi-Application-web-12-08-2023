...
try {
  ...
  $message = "Error: unable to get number of contacts";
}
...
try {
  ...
  $message = "Error: unable to display the contact list";
}
...
<head>
  ...
  <title>KGB : missions | administration | contacts</title>
</head>
        ...
        <div class="row justify-content-center gx-5 gy-3 mb-4">
          <div class="col-10 col-sm-7 col-md-6 col-lg-5">
            <form class="d-flex" action="" method="GET" role="search">
              <input class="form-control me-2" id="search-input" name="search" type="search" placeholder="<?= $search == '' ? 'Search by code name' : '' ?>" value="<?= $search == '' ? '' : $search ?>" aria-label="Search contact by code name">
        ...
        <div class="row mt-2 pb-2 mb-4 overflow-x-scroll">
          ...
          <table class="table table-dark table-striped table-hover">
            ...
            <?php if (isset($contacts)): ?>
              ...
              <tr>
              <td class="font-monospace"><input id="table-checkbox-<?= $contact->getCodeName(); ?>" name="table-checkbox-<?= $contact->getCodeName(); ?>" class="table-checkbox" type="checkbox" value="<?= $contact->getUUID(); ?>"></td>
              <td class="font-monospace">
                <a href="./contact.php?id=<?= $contact->getUUID(); ?>">
                  <?= $contact->getUUID(); ?>
                </a>
              </td>
              <?php
