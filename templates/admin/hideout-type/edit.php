...
<?php ob_start(); ?>
<script src="../../../assets/js/hideout-type/hideout-type.js" defer></script>
<?php $js = ob_get_clean(); ?>

<?php $title = "KGB : missions | administration | hideout type"?>
    ...
    <div>
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a class="link-secondary" href="?controller=hideout-type&action=list">Hideout type list</a></li>
            ...
            <form action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="hideout-type-name" name="hideout-type-name"
                           value="<?= $hideoutType->getName() ?>" maxlength="50"
                           aria-describedby="hideout-type-name-help"
                           required>
                    <div id="hideout-type-name-help" class="form-text text-light">Required. 50 characters max.
                    </div>
                </div>
