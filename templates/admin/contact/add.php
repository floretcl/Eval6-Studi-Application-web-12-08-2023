            ...
            <form action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="contact-lastname" name="contact-lastname"
                           value="" maxlength="30" aria-describedby="lastname-help">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="contact-birthday" name="contact-birthday"
                           value="" aria-describedby="birthday-help" required>
                ...
                <div class="row justify-content-center my-4">
                    <div class="col-12">
                        ...
                        <a href="?controller=contact&action=list" id="cancel-button" class="btn btn-secondary me-2">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
