...
<?php ob_start(); ?>
<script src="../../../assets/js/mission-status/mission-status.js" defer></script>
<?php $js = ob_get_clean(); ?>
    ...
    <div>
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a class="link-secondary" href="?controller=mission-status&action=list">Mission status list</a></li>
