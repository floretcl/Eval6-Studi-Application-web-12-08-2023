        ...
        <div class="row mt-2 pb-2 mb-4 overflow-x-scroll">
            <form action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="specialty-name" name="specialty-name" value=""
                           maxlength="50" aria-describedby="name-help" required>
                ...
                <div class="row justify-content-center my-4">
                    <div class="col-12">
                        ...
                        <a href="?controller=specialty&action=list" id="cancel-button" class="btn btn-secondary me-2">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
